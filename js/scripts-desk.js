...
document.getElementById("message").innerHTML = "Press <span id='command'>" + keyCombination + "</span> again<br><br>or<br><br>click here: <span class='fs-btn'>Enter Full Screen</span>";

let fsBtn = document.querySelector('.fs-btn');
